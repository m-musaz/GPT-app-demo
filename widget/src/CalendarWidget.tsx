...
const theme = {
  ...
  cardInner: (isDark: boolean) => isDark 
    ? 'bg-gray-800 border-gray-700' 
    : 'bg-gray-50 border-gray-200',
  surface: (isDark: boolean) => isDark 
    ? 'bg-gray-800' 
    : 'bg-gray-100',
  ...
  // Icons & accents
  iconBg: (isDark: boolean) => isDark ? 'bg-blue-900/40' : 'bg-blue-50',
  iconBgSuccess: (isDark: boolean) => isDark ? 'bg-emerald-900/40' : 'bg-emerald-50',
  
  // Spinners
  spinner: (isDark: boolean) => isDark ? 'border-gray-600' : 'border-gray-300',
};
